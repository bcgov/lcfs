...
class EmailNotificationRequest(BaseModel):
    ...
    organization_id: Optional[int] = Field(
        None, description="Organization ID associated with the notification"
    )
...
TEMPLATE_MAPPING = {
    ...
    "IDIR_DIRECTOR__CI_APPLICATION__ANALYST_RECOMMENDATION": "idir_director__ci_application__analyst_recommendation.html",
    ...
    "IDIR_ANALYST__CI_APPLICATION__DIRECTOR_APPROVAL": "idir_analyst__ci_application__director_approval.html",
    "IDIR_ANALYST__CI_APPLICATION__DIRECTOR_RETURNED": "idir_analyst__ci_application__director_returned.html",
    "IDIR_ANALYST__CI_APPLICATION__APPLICANT_ACTIVITY": "idir_analyst__ci_application__applicant_activity.html",
