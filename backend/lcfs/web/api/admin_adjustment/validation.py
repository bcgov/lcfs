...
class AdminAdjustmentValidation:
    ...
    async def validate_admin_adjustment_create(self, request, adjustment_data: AdminAdjustmentCreateSchema):
        pass

    async def validate_admin_adjustment_update(self, request, adjustment_data: AdminAdjustmentSchema):
