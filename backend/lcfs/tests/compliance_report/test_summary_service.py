...
async def test_supplemental_low_carbon_fuel_target_summary(
    ...
    # so that trxn_repo.calculate_available_balance_for_period is called.
    ...
    mock_trxn_repo.calculate_available_balance_for_period.return_value = (
    ...
    assert (
        line_values[17] == 1000
    )  # From mock_trxn_repo.calculate_available_balance_for_period
    assert line_values[18] == 100
    assert line_values[19] == 100
    ...
    # Ensure calculate_available_balance_for_period was called
    mock_trxn_repo.calculate_available_balance_for_period.assert_called_once_with(
...
async def test_supplemental_report_uses_existing_summary_line_17(
    ...
    summary.line_17_non_banked_units_used and trxn_repo.calculate_available_balance_for_period
    is NOT called.
    """
    compliance_period_start = datetime(2024, 1, 1)
    compliance_period_end = datetime(2024, 12, 31)
    ...
    # Assertions
    mock_trxn_repo.calculate_available_balance_for_period.assert_not_called()
