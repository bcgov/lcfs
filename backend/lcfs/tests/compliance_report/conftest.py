...
def compliance_report_update_service(
    ...
    service._charging_equipment_service = AsyncMock()
    service._charging_equipment_service.auto_submit_equipment_for_report = AsyncMock(
        return_value=0
    )
    ...
    mock_fse_repo.deactivate_decommissioned_fse_for_report = AsyncMock(return_value=0)
