...
@pytest.mark.anyio
async def test_create_internal_comment_success(
    internal_comment_service, internal_comment_repo
):
    created_internal_comment = await internal_comment_service.create_internal_comment(
        intenal_comment_create_payload
    )
...
@pytest.mark.anyio
async def test_get_internal_comments_success(
    internal_comment_service, internal_comment_repo
):
    pass
...
@pytest.mark.anyio
async def test_get_internal_comment_by_id_success(
    internal_comment_service, internal_comment_repo
):
    pass
