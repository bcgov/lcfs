...
@pytest.mark.anyio
async def test_get_transactions_paginated(client: AsyncClient, fastapi_app: FastAPI, set_mock_user_roles):
...
@pytest.mark.anyio
async def test_get_transactions_unauthenticated(client: AsyncClient, fastapi_app: FastAPI, set_mock_user_roles):
