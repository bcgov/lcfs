...
class TestGeocoderViews:
    ...
    def test_validate_address_success(self, client, mock_geocoder_service, sample_address):
    ...
    def test_validate_address_invalid_request(self, client):
    ...
    def test_forward_geocode_success(self, client, mock_geocoder_service, sample_geocoding_result):
    ...
    def test_reverse_geocode_success(self, client, mock_geocoder_service, sample_geocoding_result):
    ...
    def test_batch_geocode_success(self, client, mock_geocoder_service, sample_geocoding_result):
    ...
    def test_boundary_check_success(self, client, mock_geocoder_service):
    ...
    def test_autocomplete_success(self, client, mock_geocoder_service):
    ...
    def test_health_check_healthy(self, client, mock_geocoder_service):
        ...
        with patch('lcfs.web.api.geocoder.views.get_geocoder_service_async', return_value=mock_geocoder_service):
            response = client.get("/api/geocoder/health")
    ...
    def test_health_check_unhealthy(self, client, mock_geocoder_service):
    ...
    def test_clear_cache_success(self, client, mock_geocoder_service):
        """Test successful cache clearing endpoint."""
        mock_geocoder_service.clear_cache.return_value = None
        
        with patch('lcfs.web.api.geocoder.views.get_geocoder_service_async', return_value=mock_geocoder_service):
            response = client.delete("/api/geocoder/cache")
    ...
    def test_clear_cache_error(self, client, mock_geocoder_service):
    ...
    def test_service_error_handling(self, client, mock_geocoder_service):
    ...
    def test_batch_geocode_mixed_results(self, client, mock_geocoder_service):
