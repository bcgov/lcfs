...
async def seed_organization_types(session):
    ...
    org_types_to_seed = [
        {"organization_type_id": 1, "org_type": OrgTypeEnum.fuel_supplier,
            "description": "Fuel Supplier"},
        {"organization_type_id": 2, "org_type": OrgTypeEnum.electricity_supplier,
            "description": "Electricity Supplier"},
        {"organization_type_id": 3, "org_type": OrgTypeEnum.broker,
            "description": "Broker"},
        {"organization_type_id": 4, "org_type": OrgTypeEnum.utilities,
