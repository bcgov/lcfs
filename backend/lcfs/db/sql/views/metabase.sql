...
SELECT
      ...
      "Fuel Code - fuel_code_id"."fuel_code_id" AS "FC - fc_id__fuel_code_id",
      "Fuel Code - fuel_code_id"."fuel_status_id" AS "FC - fc_id__fuel_status_id",
      "Fuel Code - fuel_code_id"."prefix_id" AS "FC - fc_id__prefix_id",
      "Fuel Code - fuel_code_id"."fuel_suffix" AS "FC - fc_id__fuel_suffix",
      "Fuel Code - fuel_code_id"."company" AS "FC - fc_id__company",
      "Fuel Code - fuel_code_id"."contact_name" AS "FC - fc_id__contact_name",
      "Fuel Code - fuel_code_id"."contact_email" AS "FC - fc_id__contact_email",
      "Fuel Code - fuel_code_id"."carbon_intensity" AS "FC - fc_id__carbon_intensity",
      "Fuel Code - fuel_code_id"."edrms" AS "FC - fc_id__edrms",
      "Fuel Code - fuel_code_id"."last_updated" AS "FC - fc_id__last_updated",
      "Fuel Code - fuel_code_id"."application_date" AS "FC - fc_id__application_date",
      "Fuel Code - fuel_code_id"."approval_date" AS "FC - fc_id__approval_date",
      "Fuel Code - fuel_code_id"."fuel_type_id" AS "FC - fc_id__fuel_type_id",
      "Fuel Code - fuel_code_id"."feedstock" AS "FC - fc_id__feedstock",
      "Fuel Code - fuel_code_id"."feedstock_location" AS "FC - fc_id__feedstock_location",
      "Fuel Code - fuel_code_id"."feedstock_misc" AS "FC - fc_id__feedstock_misc",
      "Fuel Code - fuel_code_id"."fuel_production_facility_city" AS "FC - fc_id__fuel_production_facility_city",
      "Fuel Code - fuel_code_id"."fuel_production_facility_province_state" AS "FC - fc_id__fuel_production_facility_province_state",
      "Fuel Code - fuel_code_id"."fuel_production_facility_country" AS "FC - fc_id__fuel_production_facility_country",
      "Fuel Code - fuel_code_id"."facility_nameplate_capacity" AS "FC - fc_id__facility_nameplate_capacity",
      "Fuel Code - fuel_code_id"."facility_nameplate_capacity_unit" AS "FC - fc_id__facility_nameplate_capacity_unit",
      "Fuel Code - fuel_code_id"."former_company" AS "FC - fc_id__former_company",
      "Fuel Code - fuel_code_id"."notes" AS "FC - fc_id__notes",
      "Fuel Code - fuel_code_id"."create_date" AS "FC - fc_id__create_date",
      "Fuel Code - fuel_code_id"."update_date" AS "FC - fc_id__update_date",
      "Fuel Code - fuel_code_id"."create_user" AS "FC - fc_id__create_user",
      "Fuel Code - fuel_code_id"."update_user" AS "FC - fc_id__update_user",
      "Fuel Code - fuel_code_id"."effective_date" AS "FC - fc_id__effective_date",
      "Fuel Code - fuel_code_id"."effective_status" AS "FC - fc_id__effective_status",
      "Fuel Code - fuel_code_id"."expiration_date" AS "FC - fc_id__expiration_date"
    FROM
      (
        WITH latest_fs AS (
          SELECT
...
SELECT
      ...
      "Compliance Report groups - Compliance Report"."compliance_report_id" AS "CR groups - CR__cr_id",
      "Compliance Report groups - Compliance Report"."compliance_report_group_uuid" AS "CR groups - CR__cr_group_uuid",
      "Compliance Report groups - Compliance Report"."version" AS "CR groups - CR__version",
      "Compliance Report groups - Compliance Report"."compliance_period" AS "CR groups - CR__compliance_period",
      "Compliance Report groups - Compliance Report"."organization_name" AS "CR groups - CR__organization_name",
      "Compliance Report groups - Compliance Report"."report_status" AS "CR groups - CR__report_status"
    FROM
      (
        SELECT
...
LEFT JOIN (
        SELECT
          ...
          "source"."report_status" AS "report_status",
          "Compliance Report - Compliance Report Group UUID"."compliance_report_id" AS "CR - CR Group UUID__compliance_report_id",
          "Compliance Report - Compliance Report Group UUID"."transaction_id" AS "CR - CR Group UUID__transaction_id",
          "Compliance Report - Compliance Report Group UUID"."legacy_id" AS "CR - CR Group UUID__legacy_id",
          "Compliance Report - Compliance Report Group UUID"."version" AS "CR - CR Group UUID__version",
          "Compliance Report - Compliance Report Group UUID"."supplemental_initiator" AS "CR - CR Group UUID__supplemental_initiator",
          "Compliance Report - Compliance Report Group UUID"."current_status_id" AS "CR - CR Group UUID__current_status_id"
        FROM
          (
            SELECT
    ...
    OR (
      ...
      ) AS "Compliance Report groups - Compliance Report" ON "Compliance Report groups - Compliance Report"."compliance_report_id" = "Compliance Report groups - Compliance Report"."Compliance Report - Compliance Report Group UUID__compliance_report_id";
...
SELECT
      ...
      "Compliance Report Base - Compliance Report"."compliance_report_id" AS "CR Base - CR__compliance_report_id",
      "Compliance Report Base - Compliance Report"."compliance_period_id" AS "CR Base - CR__compliance_period_id",
      "Compliance Report Base - Compliance Report"."organization_id" AS "CR Base - CR__organization_id",
      "Compliance Report Base - Compliance Report"."current_status_id" AS "CR Base - CR__current_status_id",
      "Compliance Report Base - Compliance Report"."transaction_id" AS "CR Base - CR__transaction_id",
      "Compliance Report Base - Compliance Report"."compliance_report_group_uuid" AS "CR Base - CR__compliance_report_group_uuid",
      "Compliance Report Base - Compliance Report"."legacy_id" AS "CR Base - CR__legacy_id",
      "Compliance Report Base - Compliance Report"."version" AS "CR Base - CR__version",
      "Compliance Report Base - Compliance Report"."supplemental_initiator" AS "CR Base - CR__supplemental_initiator",
      "Compliance Report Base - Compliance Report"."reporting_frequency" AS "CR Base - CR__reporting_frequency",
      "Compliance Report Base - Compliance Report"."nickname" AS "CR Base - CR__nickname",
      "Compliance Report Base - Compliance Report"."supplemental_note" AS "CR Base - CR__supplemental_note",
      "Compliance Report Base - Compliance Report"."create_date" AS "CR Base - CR__create_date",
      "Compliance Report Base - Compliance Report"."update_date" AS "CR Base - CR__update_date",
      "Compliance Report Base - Compliance Report"."create_user" AS "CR Base - CR__create_user",
      "Compliance Report Base - Compliance Report"."update_user" AS "CR Base - CR__update_user",
      "Compliance Report Base - Compliance Report"."assessment_statement" AS "CR Base - CR__assessment_statement",
      "Compliance Report Base - Compliance Report"."Renewable Requirements" AS "CR Base - CR__Renewable_Requirements",
      "Compliance Report Base - Compliance Report"."Low Carbon Requirements" AS "CR Base - CR__Low_Carbon_Requirements",
      "Compliance Report Base - Compliance Report"."Compliance Period__compliance_period_id" AS "CR Base - CR__Compliance_Period__compliance_period_id",
      "Compliance Report Base - Compliance Report"."Compliance Period__description" AS "CR Base - CR__Compliance_Period__description",
      "Compliance Report Base - Compliance Report"."Compliance Period__display_order" AS "CR Base - CR__Compliance_Period__display_order",
      "Compliance Report Base - Compliance Report"."Compliance Period__create_date" AS "CR Base - CR__Compliance_Period__create_date",
      "Compliance Report Base - Compliance Report"."Compliance Period__update_date" AS "CR Base - CR__Compliance_Period__update_date",
      "Compliance Report Base - Compliance Report"."Compliance Period__effective_date" AS "CR Base - CR__Compliance_Period__effective_date",
      "Compliance Report Base - Compliance Report"."Compliance Period__effective_status" AS "CR Base - CR__Compliance_Period__effective_status",
      "Compliance Report Base - Compliance Report"."Compliance Period__expiration_date" AS "CR Base - CR__Compliance_Period__expiration_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__compliance_report_status_id" AS "CR Base - CR__CR_Status_Current_Status__cr_status_id",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__display_order" AS "CR Base - CR__CR_Status_Current_Status__display_order",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__status" AS "CR Base - CR__CR_Status_Current_Status__status",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__create_date" AS "CR Base - CR__CR_Status_Current_Status__create_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__update_date" AS "CR Base - CR__CR_Status_Current_Status__update_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__effective_date" AS "CR Base - CR__CR_Status_Current_Status__effective_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__effective_status" AS "CR Base - CR__CR_Status_Current_Status__effective_status",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__expiration_date" AS "CR Base - CR__CR_Status_Current_Status__expiration_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__summary_id" AS "CR Base - Summary__summary_id",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__compliance_report_id" AS "CR Base - Summary__compliance_report_id",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__quarter" AS "CR Base - Summary__quarter",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__is_locked" AS "CR Base - Summary__is_locked",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_1_fossil_derived_base_fuel_gasoline" AS "CR Base - Summary__line_1_fossil_derived_base_fuel_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_1_fossil_derived_base_fuel_diesel" AS "CR Base - Summary__line_1_fossil_derived_base_fuel_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_1_fossil_derived_base_fuel_jet_fuel" AS "CR Base - Summary__line_1_fossil_derived_base_fuel_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_2_eligible_renewable_fuel_supplied_gasoline" AS "CR Base - Summary__line_2_eligible_renewable_fs_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_2_eligible_renewable_fuel_supplied_diesel" AS "CR Base - Summary__line_2_eligible_renewable_fs_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_2_eligible_renewable_fuel_supplied_jet_fuel" AS "CR Base - Summary__line_2_eligible_renewable_fs_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_3_total_tracked_fuel_supplied_gasoline" AS "CR Base - Summary__line_3_total_tracked_fs_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_3_total_tracked_fuel_supplied_diesel" AS "CR Base - Summary__line_3_total_tracked_fs_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_3_total_tracked_fuel_supplied_jet_fuel" AS "CR Base - Summary__line_3_total_tracked_fs_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_4_eligible_renewable_fuel_required_gasoline" AS "CR Base - Summary__line_4_eligible_renewable_fuel_req_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_4_eligible_renewable_fuel_required_diesel" AS "CR Base - Summary__line_4_eligible_renewable_fuel_req_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_4_eligible_renewable_fuel_required_jet_fuel" AS "CR Base - Summary__line_4_eligible_renewable_fuel_req_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_5_net_notionally_transferred_gasoline" AS "CR Base - Summary__line_5_net_notionally_transferred_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_5_net_notionally_transferred_diesel" AS "CR Base - Summary__line_5_net_notionally_transferred_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_5_net_notionally_transferred_jet_fuel" AS "CR Base - Summary__line_5_net_notionally_transferred_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_6_renewable_fuel_retained_gasoline" AS "CR Base - Summary__line_6_renewable_fuel_retained_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_6_renewable_fuel_retained_diesel" AS "CR Base - Summary__line_6_renewable_fuel_retained_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_6_renewable_fuel_retained_jet_fuel" AS "CR Base - Summary__line_6_renewable_fuel_retained_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_7_previously_retained_gasoline" AS "CR Base - Summary__line_7_previously_retained_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_7_previously_retained_diesel" AS "CR Base - Summary__line_7_previously_retained_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_7_previously_retained_jet_fuel" AS "CR Base - Summary__line_7_previously_retained_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_8_obligation_deferred_gasoline" AS "CR Base - Summary__line_8_obligation_deferred_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_8_obligation_deferred_diesel" AS "CR Base - Summary__line_8_obligation_deferred_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_8_obligation_deferred_jet_fuel" AS "CR Base - Summary__line_8_obligation_deferred_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_9_obligation_added_gasoline" AS "CR Base - Summary__line_9_obligation_added_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_9_obligation_added_diesel" AS "CR Base - Summary__line_9_obligation_added_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_9_obligation_added_jet_fuel" AS "CR Base - Summary__line_9_obligation_added_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_10_net_renewable_fuel_supplied_gasoline" AS "CR Base - Summary__line_10_net_renewable_fuel_supplied_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_10_net_renewable_fuel_supplied_diesel" AS "CR Base - Summary__line_10_net_renewable_fuel_supplied_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_10_net_renewable_fuel_supplied_jet_fuel" AS "CR Base - Summary__line_10_net_renewable_fuel_supplied_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_non_compliance_penalty_gasoline" AS "CR Base - Summary__line_11_non_compliance_penalty_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_non_compliance_penalty_diesel" AS "CR Base - Summary__line_11_non_compliance_penalty_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_non_compliance_penalty_jet_fuel" AS "CR Base - Summary__line_11_non_compliance_penalty_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_12_low_carbon_fuel_required" AS "CR Base - Summary__line_12_low_carbon_fuel_required",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_13_low_carbon_fuel_supplied" AS "CR Base - Summary__line_13_low_carbon_fuel_supplied",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_14_low_carbon_fuel_surplus" AS "CR Base - Summary__line_14_low_carbon_fuel_surplus",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_15_banked_units_used" AS "CR Base - Summary__line_15_banked_units_used",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_16_banked_units_remaining" AS "CR Base - Summary__line_16_banked_units_remaining",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_17_non_banked_units_used" AS "CR Base - Summary__line_17_non_banked_units_used",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_18_units_to_be_banked" AS "CR Base - Summary__line_18_units_to_be_banked",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_19_units_to_be_exported" AS "CR Base - Summary__line_19_units_to_be_exported",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_20_surplus_deficit_units" AS "CR Base - Summary__line_20_surplus_deficit_units",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_21_surplus_deficit_ratio" AS "CR Base - Summary__line_21_surplus_deficit_ratio",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_22_compliance_units_issued" AS "CR Base - Summary__line_22_compliance_units_issued",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_gasoline" AS "CR Base - CR__line_11_fossil_derived_base_fuel_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_diesel" AS "CR Base - CR__line_11_fossil_derived_base_fuel_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_jet_fuel" AS "CR Base - CR__line_11_fossil_derived_base_fuel_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_total" AS "CR Base - CR__line_11_fossil_derived_base_fuel_total",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_21_non_compliance_penalty_payable" AS "CR Base - CR__line_21_non_compliance_penalty_payable",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__total_non_compliance_penalty_payable" AS "CR Base - CR__total_non_compliance_penalty_payable",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__credits_offset_a" AS "CR Base - CR__credits_offset_a",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__credits_offset_b" AS "CR Base - CR__credits_offset_b",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__credits_offset_c" AS "CR Base - CR__credits_offset_c",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__create_date" AS "CR Base - CR__create_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__update_date" AS "CR Base - CR__update_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__create_user" AS "CR Base - CR__create_user",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__update_user" AS "CR Base - CR__update_user",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q1" AS "CR Base - CR__early_issuance_credits_q1",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q2" AS "CR Base - CR__early_issuance_credits_q2",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q3" AS "CR Base - CR__early_issuance_credits_q3",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q4" AS "CR Base - CR__early_issuance_credits_q4",
      "Compliance Report Base - Compliance Report"."Transaction__transaction_id" AS "CR Base - CR__transaction_id",
      "Compliance Report Base - Compliance Report"."Transaction__compliance_units" AS "CR Base - CR__compliance_units",
      "Compliance Report Base - Compliance Report"."Transaction__organization_id" AS "CR Base - CR__Transaction__organization_id",
      "Compliance Report Base - Compliance Report"."Transaction__transaction_action" AS "CR Base - CR__Transaction__transaction_action",
      "Compliance Report Base - Compliance Report"."Transaction__create_date" AS "CR Base - CR__Transaction__create_date",
      "Compliance Report Base - Compliance Report"."Transaction__update_date" AS "CR Base - CR__Transaction__update_date",
      "Compliance Report Base - Compliance Report"."Transaction__create_user" AS "CR Base - CR__Transaction__create_user",
      "Compliance Report Base - Compliance Report"."Transaction__update_user" AS "CR Base - CR__Transaction__update_user",
      "Compliance Report Base - Compliance Report"."Transaction__effective_date" AS "CR Base - CR__Transaction__effective_date",
      "Compliance Report Base - Compliance Report"."Transaction__effective_status" AS "CR Base - CR__Transaction__effective_status",
      "Compliance Report Base - Compliance Report"."Transaction__expiration_date" AS "CR Base - CR__Transaction__expiration_date",
      "Compliance Report Base - Compliance Report"."Organization__organization_id" AS "CR Base - CR__Organization__organization_id",
      "Compliance Report Base - Compliance Report"."Organization__organization_code" AS "CR Base - CR__Organization__organization_code",
      "Compliance Report Base - Compliance Report"."Organization__name" AS "CR Base - CR__Organization__name",
      "Compliance Report Base - Compliance Report"."Organization__operating_name" AS "CR Base - CR__Organization__operating_name",
      "Compliance Report Base - Compliance Report"."Organization__email" AS "CR Base - CR__Organization__email",
      "Compliance Report Base - Compliance Report"."Organization__phone" AS "CR Base - CR__Organization__phone",
      "Compliance Report Base - Compliance Report"."Organization__edrms_record" AS "CR Base - CR__Organization__edrms_record",
      "Compliance Report Base - Compliance Report"."Organization__total_balance" AS "CR Base - CR__Organization__total_balance",
      "Compliance Report Base - Compliance Report"."Organization__reserved_balance" AS "CR Base - CR__Organization__reserved_balance",
      "Compliance Report Base - Compliance Report"."Organization__count_transfers_in_progress" AS "CR Base - CR__Organization__count_transfers_in_progress",
      "Compliance Report Base - Compliance Report"."Organization__organization_status_id" AS "CR Base - CR__Organization__organization_status_id",
      "Compliance Report Base - Compliance Report"."Organization__organization_type_id" AS "CR Base - CR__Organization__organization_type_id",
      "Compliance Report Base - Compliance Report"."Organization__organization_address_id" AS "CR Base - CR__Organization__organization_address_id",
      "Compliance Report Base - Compliance Report"."Organization__organization_attorney_address_id" AS "CR Base - CR__Organization__organization_attorney_address_id",
      "Compliance Report Base - Compliance Report"."Organization__create_date" AS "CR Base - CR__Organization__create_date",
      "Compliance Report Base - Compliance Report"."Organization__update_date" AS "CR Base - CR__Organization__update_date",
      "Compliance Report Base - Compliance Report"."Organization__create_user" AS "CR Base - CR__Organization__create_user",
      "Compliance Report Base - Compliance Report"."Organization__update_user" AS "CR Base - CR__Organization__update_user",
      "Compliance Report Base - Compliance Report"."Organization__effective_date" AS "CR Base - CR__Organization__effective_date",
      "Compliance Report Base - Compliance Report"."Organization__effective_status" AS "CR Base - CR__Organization__effective_status",
      "Compliance Report Base - Compliance Report"."Organization__expiration_date" AS "CR Base - CR__Organization__expiration_date",
      "Compliance Report Base - Compliance Report"."Organization__has_early_issuance" AS "CR Base - CR__Organization__has_early_issuance",
      "Compliance Report Base - Compliance Report"."Organization__records_address" AS "CR Base - CR__Organization__records_address",
      "Compliance Report Base - Compliance Report"."Compliance Reports Chained - Compliance Report Group UUID__group_uuid" AS "CR Base - CR__group_uuid",
      "Compliance Report Base - Compliance Report"."Compliance Reports Chained - Compliance Report Group UUID__max_version" AS "CR Base - CR__max_version"
    FROM
      (
        SELECT
          "allocation_agreement"."group_uuid" AS "group_uuid",
