...
SELECT
      ...
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__compliance_report_status_id" AS "CR Base - CR_Status_Current_Status__cr_status_id",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__display_order" AS "CR Base - CR_Status_Current_Status__display_order",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__status" AS "CR Base - CR_Status_Current_Status__status",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__create_date" AS "CR Base - CR_Status_Current_Status__create_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__update_date" AS "CR Base - CR_Status_Current_Status__update_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__effective_date" AS "CR Base - CR_Status_Current_Status__effective_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__effective_status" AS "CR Base - CR_Status_Current_Status__effective_status",
      "Compliance Report Base - Compliance Report"."Compliance Report Status - Current Status__expiration_date" AS "CR Base - CR_Status_Current_Status__expiration_date",
      ...
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_gasoline" AS "CR Base - line_11_fossil_derived_base_fuel_gasoline",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_diesel" AS "CR Base - line_11_fossil_derived_base_fuel_diesel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_jet_fuel" AS "CR Base - line_11_fossil_derived_base_fuel_jet_fuel",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_11_fossil_derived_base_fuel_total" AS "CR Base - line_11_fossil_derived_base_fuel_total",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__line_21_non_compliance_penalty_payable" AS "CR Base - line_21_non_compliance_penalty_payable",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__total_non_compliance_penalty_payable" AS "CR Base - total_non_compliance_penalty_payable",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__credits_offset_a" AS "CR Base - credits_offset_a",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__credits_offset_b" AS "CR Base - credits_offset_b",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__credits_offset_c" AS "CR Base - credits_offset_c",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__create_date" AS "CR Base - create_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__update_date" AS "CR Base - update_date",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__create_user" AS "CR Base - create_user",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__update_user" AS "CR Base - update_user",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q1" AS "CR Base - early_issuance_credits_q1",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q2" AS "CR Base - early_issuance_credits_q2",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q3" AS "CR Base - early_issuance_credits_q3",
      "Compliance Report Base - Compliance Report"."Compliance Report Summary - Compliance Report__early_issuance_credits_q4" AS "CR Base - early_issuance_credits_q4",
      "Compliance Report Base - Compliance Report"."Transaction__transaction_id" AS "CR Base - transaction_id",
      ...
      "Compliance Report Base - Compliance Report"."Compliance Reports Chained - Compliance Report Group UUID__group_uuid" AS "CR Base - group_uuid",
      "Compliance Report Base - Compliance Report"."Compliance Reports Chained - Compliance Report Group UUID__max_version" AS "CR Base - max_version"
    FROM
      (
        SELECT
          "allocation_agreement"."group_uuid" AS "group_uuid",
