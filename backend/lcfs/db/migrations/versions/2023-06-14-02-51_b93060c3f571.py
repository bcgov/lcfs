...
Revision ID: b93060c3f571
Revises:
Create Date: 2023-06-14 02:51:52.471593
...
def downgrade() -> None:
    ...
    op.drop_table("organization_history", schema="public")
    ...
    op.drop_table("organization_type", schema="public")
    # ### end Alembic commands ###
