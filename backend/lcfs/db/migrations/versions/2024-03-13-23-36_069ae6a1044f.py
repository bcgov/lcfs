...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "admin_adjustment_history_admin_adjustment_history_id_key", "admin_adjustment_history", ["admin_adjustment_history_id"]
    )
    op.create_unique_constraint("comment_comment_id_fkey", "comment", ["comment_id"])
    op.create_unique_constraint(
        "initiative_agreement_initiative_agreement_id_key", "initiative_agreement", ["initiative_agreement_id"]
    )
    op.create_unique_constraint(
        "iah_initiative_agreement_history_id_key", "initiative_agreement_history", ["initiative_agreement_history_id"]
    )
    op.alter_column(
        "transaction",
        "transaction_action",
    ...
    op.create_foreign_key(
        "transfer_from_transaction_id_fkey", "transfer", "transaction", ["from_transaction_id"], ["transaction_id"]
    )
    op.create_foreign_key(
        "transfer_to_transaction_id_fkey", "transfer", "transaction", ["to_transaction_id"], ["transaction_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint("transfer_to_transaction_id_fkey", "transfer", type_="foreignkey")
    op.drop_constraint("transfer_from_transaction_id_fkey", "transfer", type_="foreignkey")
    op.create_foreign_key(
    ...
    op.drop_constraint("iah_initiative_agreement_history_id_key", "initiative_agreement_history", type_="unique")
    op.drop_constraint("initiative_agreement_initiative_agreement_id_key", "initiative_agreement", type_="unique")
    op.drop_constraint("comment_comment_id_fkey", "comment", type_="unique")
