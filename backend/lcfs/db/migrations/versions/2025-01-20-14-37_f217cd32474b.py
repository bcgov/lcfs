...
def create_materialized_views():
    ...
    op.execute(
        ...
        SELECT
            ...
            tc.category,
            th.create_date AS recorded_date,
        ...
        LEFT JOIN transfer_history th ON th.transfer_id = t.transfer_id AND th.transfer_status_id = 6
        ...
        SELECT
            ...
            NULL AS category,
            iah.create_date AS recorded_date,
            NULL AS approved_date,
        ...
        LEFT JOIN initiative_agreement_history iah ON iah.initiative_agreement_id = ia.initiative_agreement_id AND iah.initiative_agreement_status_id = 3
        ...
        SELECT
            ...
            NULL AS category,
            aah.create_date AS recorded_date,
            NULL AS approved_date,
        ...
        LEFT JOIN admin_adjustment_history aah ON aah.admin_adjustment_id = aa.admin_adjustment_id AND aah.admin_adjustment_status_id = 3
