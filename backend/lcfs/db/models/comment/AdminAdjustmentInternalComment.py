...
class AdminAdjustmentInternalComment(BaseModel):
    ...
    admin_adjustment_id = Column(
        Integer,
        ForeignKey("admin_adjustment.admin_adjustment_id"),
        primary_key=True,
    ...
    # Relationships
    admin_adjustment = relationship(
        "AdminAdjustment", back_populates="admin_adjustment_internal_comments"
    )
    internal_comment = relationship(
        "InternalComment", back_populates="admin_adjustment_internal_comments"
    )
