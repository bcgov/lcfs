...
class ExpectedUseType(BaseModel, Auditable, DisplayOrder, EffectiveDates):
    ...
    __table_args__ = {"comment": "Represents an expected use type for other fuels"}

    expected_use_type_id = Column(
        Integer,
        primary_key=True,
        autoincrement=True,
    ...
    description = Column(
        Text, nullable=True, comment="Description of the expected use type"
    )
