...
class FuelType(BaseModel, Auditable, DisplayOrder):
    ...
    provision_1_id = Column(Integer, ForeignKey("provision_of_the_act.provision_of_the_act_id"), nullable=True)
    provision_2_id = Column(Integer, ForeignKey("provision_of_the_act.provision_of_the_act_id"), nullable=True)
    ...
    provision_1 = relationship('ProvisionOfTheAct', foreign_keys=[provision_1_id], back_populates="fuel_type_provision_1")
    provision_2 = relationship('ProvisionOfTheAct', foreign_keys=[provision_2_id], back_populates="fuel_type_provision_2")
