...
class OrganizationBalance(BaseModel, Auditable, EffectiveDates):
    ...
    __table_args__ = {'comment': "Represents a fuel supplier organization's credit balance at a given point in time. The government organization does not have an actual credit balance, but rather one was set artificially high to enable the awarding or validating of credits to fuel suppliers within LCFS."}
