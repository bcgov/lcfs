...
class FuelExport(BaseModel, Auditable):
    ...
    fuel_export_id = Column(Integer, primary_key=True, autoincrement=True, comment="Unique identifier for the fuel supply")
    ...
    previous_fuel_export_id = Column(Integer, ForeignKey('fuel_export.fuel_export_id'), nullable=True, comment="Foreign key to the previous fuel supply record")
    ...
    supplemental_report = relationship('SupplementalReport', back_populates='fuel_exports')
