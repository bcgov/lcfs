...
class ComplianceReportSummary(BaseModel, Auditable):
    ...
    line_1_fossil_derived_base_fuel_gasoline = Column(
        Integer, nullable=False, default=0
    )
    line_1_fossil_derived_base_fuel_diesel = Column(Integer, nullable=False, default=0)
    line_1_fossil_derived_base_fuel_jet_fuel = Column(
        Integer, nullable=False, default=0
    )
    ...
    line_3_total_tracked_fuel_supplied_diesel = Column(
        Integer, nullable=False, default=0
    )
    ...
    line_5_net_notionally_transferred_diesel = Column(
        Integer, nullable=False, default=0
    )
    ...
    line_12_low_carbon_fuel_required = Column(Integer, nullable=False, default=0)
    line_13_low_carbon_fuel_supplied = Column(Integer, nullable=False, default=0)
    line_14_low_carbon_fuel_surplus = Column(Integer, nullable=False, default=0)
    line_15_banked_units_used = Column(Integer, nullable=False, default=0)
    line_16_banked_units_remaining = Column(Integer, nullable=False, default=0)
    line_17_non_banked_units_used = Column(Integer, nullable=False, default=0)
    line_18_units_to_be_banked = Column(Integer, nullable=False, default=0)
    line_19_units_to_be_exported = Column(Integer, nullable=False, default=0)
    line_20_surplus_deficit_units = Column(Integer, nullable=False, default=0)
    line_21_surplus_deficit_ratio = Column(Float, nullable=False, default=0)
    line_22_compliance_units_issued = Column(Integer, nullable=False, default=0)
