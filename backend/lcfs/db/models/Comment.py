...
class Comment(BaseModel,Auditable, EffectiveDates):
    ...
    __table_args__ = {'comment': "Comment for transaction"}


    id = Column(Integer, Sequence('issuance_id'), comment="Unique identifier for comment", primary_key=True, autoincrement=True)
