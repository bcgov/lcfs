...
describe('BCGridBase Component', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders with default props', () => {
      ...
      expect(container.querySelector('[data-testid="ag-grid-react"]')).toBeInTheDocument()
    })
  ...
  describe('Row Styling', () => {
    it('returns highlighted background when params.node.id matches highlightedId', () => {
      ...
      const getRowStyleCall = vi.mocked(AgGridReact).mock.calls[0][0].getRowStyle
  ...
  describe('Height Management', () => {
    ...
    it('sets normal layout when displayedRowCount > maxVisibleRows', async () => {
      ...
      // Mock AgGridReact to call onGridReady after render
  ...
  describe('Props Integration', () => {
    ...
    it('receives all expected AgGridReact props and configuration', () => {
      ...
      expect(agGridProps.loadingOverlayComponentParams.loadingMessage).toBe('One moment please...')
    })
