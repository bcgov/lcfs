...
describe('DocumentUploadDialog', () => {
  ...
  it('should render with initial state and props', () => {
    ...
    expect(screen.getByTestId('bc-typography')).toHaveTextContent('Supporting Documents')
    expect(screen.getByTestId('document-table')).toBeInTheDocument()
  })

  it('should not render when open is false', () => {
    render(
      <DocumentUploadDialog {...defaultProps} open={false} />, 
      { wrapper }
    )
  ...
  it('should pass correct props to DocumentTable', () => {
    ...
    expect(documentTable).toHaveAttribute('data-parent-type', 'compliance-report')
  })

  it('should handle close action when secondary button is clicked', () => {
    const mockClose = vi.fn()
    render(
      <DocumentUploadDialog {...defaultProps} close={mockClose} />, 
      { wrapper }
    )
