...
export const ROUTES = {
  ...
  REPORTS: {
    ...
    CHARGING_SITE: '/compliance-reporting/charging-sites',
    ADD_CHARGING_SITE: '/compliance-reporting/charging-sites/add',
    EDIT_CHARGING_SITE: '/compliance-reporting/charging-sites/:siteId/edit',
