  ...
  BCGridViewer: vi.fn(
    ({
      ...
      <div data-test="bc-grid-viewer">
        ...
        <div data-test="column-defs">
          {JSON.stringify(columnDefs?.map((col) => col.field) || [])}
        </div>
        <div data-test="row-id">
          {getRowId && queryData?.data?.items?.[0]
...
describe('FuelExportChangelog', () => {
  ...
  describe('Component Rendering', () => {
    it('should render loading component when currentReportLoading is true', () => {
      ...
      render(<FuelExportChangelog />, { fixtureOptions })
      ...
      const changelogData = [
        {
          ...
          version: 1,
          fuelExports: Array.from({ length: 10 }, (_, i) => ({
            fuelExportId: i + 1,
            fuelType: 'Gasoline'
          }))
        }
  ...
  describe('Data Processing', () => {
    ...
    it('should return all data for non-current version without pagination', () => {
      ...
      expect(
        grids[1].querySelector('[data-test="row-count"]')
  ...
  describe('Component Behavior Verification', () => {
    ...
    it('should handle re-renders correctly', () => {
      ...
      const { rerender } = render(<FuelExportChangelog />, { fixtureOptions })
