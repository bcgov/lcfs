...
import OrgTransactionDetails, { ADMIN_ADJUSTMENT, INITIATIVE_AGREEMENT } from '@/views/Transactions/components/OrgTransactionDetails';
...
vi.mock('@/utils/formatters', () => ({
  ...
  dateFormatter: vi.fn(({ value }) => new Date(value).toISOString().split('T')[0]),
}));
