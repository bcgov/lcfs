...
vi.mock('@/components/BCButton', () => ({
  default: ({ children, onClick }) => (
    <button onClick={onClick} data-test="submit-button">
      {children}
    </button>
  )
}))
...
describe('SigningAuthorityDeclaration', () => {
  it('renders the component correctly', () => {
    ...
    expect(
      screen.getByText('Signing authority declaration')
    ).toBeInTheDocument()
    expect(
      screen.getByText(/I certify that the information in this report is true/)
    ).toBeInTheDocument()
