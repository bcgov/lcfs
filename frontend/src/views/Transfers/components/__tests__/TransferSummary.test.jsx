...
describe('TransferSummary', () => {
  ...
  describe('Component Rendering', () => {
    test('renders with valid props', ({ render, theme }) => {
      render(
        <TransferSummary
    ...
    test('renders with default props', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={{
    ...
    test('renders with empty formData', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={{
  ...
  describe('Translation Usage', () => {
    test('uses all translation keys correctly', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={mockFormData}
  ...
  describe('Formatter Function Calls', () => {
    test('calls formatNumberWithCommas for quantity', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={mockFormData}
    ...
    test('calls decimalFormatter for pricePerUnit', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={mockFormData}
  ...
  describe('Organization Names Display', () => {
    test('displays fromOrganization name correctly', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={mockFormData}
    ...
    test('displays toOrganization name correctly', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={mockFormData}
  ...
  describe('Edge Cases', () => {
    test('handles zero quantity', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
    ...
    test('handles zero pricePerUnit', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
    ...
    test('handles different date formats', ({ render, theme }) => {
    ...
    test('handles undefined formData', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={mockTransferData}
          formData={{
  ...
  describe('Default Values', () => {
    test('uses default formData when not provided', ({ render, theme }) => {
      render(
        <TransferSummary
          transferData={{
            fromOrganization: { name: '' },
