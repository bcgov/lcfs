...
vi.mock('../components/TransferSummary', () => ({
  ...
  describe('buttonClusterConfigFn', () => {
    ...
    describe('When status is Recommended', () => {
      ...
      it('should return director buttons for government user with director role', () => {
        ...
        const refuseButton = buttons.find(
          (button) => button.id === 'refuse-btn'
        )
    ...
    describe('Button Handler Tests', () => {
      ...
      beforeEach(() => {
        mockParams = {
          ...
          methods: {
            getValues: vi.fn((key) => (key === 'fromOrganizationId' ? 1 : 2))
          },
          t: vi.fn((key) => key),
          setModalData: vi.fn(),
      ...
      it('should call rescindTransfer handler correctly', () => {
        mockParams.transferData.currentStatus.status =
        ...
        const rescindButton = result.Submitted.find(
          (btn) => btn.id === 'rescind-btn'
        )
    ...
    describe('Additional Branch Coverage', () => {
      ...
      it('should test isGovernmentUser flag usage', () => {
        ...
        const saveCommentBtn = config.Submitted.find(
          (btn) => btn.id === 'save-comment-btn'
        )
      ...
      describe('Comparison with Analyst', () => {
        it('should show same "Recommend" button but with tooltip for Director', () => {
          ...
          const analystConfig = buttonClusterConfigFn({
            ...
            hasRoles: vi
              .fn()
              .mockImplementation((role) => role === roles.analyst),
