...
describe('FinalSupplyEquipment Schema', () => {
  it('should have separate supplyFromDate and supplyToDate columns using the DateEditor component', () => {
    ...
    const supplyFromDateColumn = colDefs.find(col => col.field === 'supplyFromDate')
    const supplyToDateColumn = colDefs.find(col => col.field === 'supplyToDate')
    ...
    expect(supplyFromDateColumn.cellEditorParams.autoOpenLastRow).toBe(!mockGridReady)
    expect(supplyToDateColumn.cellEditorParams.autoOpenLastRow).toBe(!mockGridReady)
    ...
    expect(supplyFromDateColumn.cellEditorParams.minDate.getFullYear()).toBe(expectedMinDate.getFullYear())
    expect(supplyFromDateColumn.cellEditorParams.minDate.getMonth()).toBe(expectedMinDate.getMonth())
    expect(supplyFromDateColumn.cellEditorParams.minDate.getDate()).toBe(expectedMinDate.getDate())
    
    expect(supplyToDateColumn.cellEditorParams.maxDate.getFullYear()).toBe(expectedMaxDate.getFullYear())
    expect(supplyToDateColumn.cellEditorParams.maxDate.getMonth()).toBe(expectedMaxDate.getMonth())
    expect(supplyToDateColumn.cellEditorParams.maxDate.getDate()).toBe(expectedMaxDate.getDate())
  })
})