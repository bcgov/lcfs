...
export const fuelCodeColDefs = (
  ...
  const fieldOptions = getFieldOptions(optionsData)
  ...
  return [
    ...
    },
    {
      ...
      valueGetter: (params) => {
        if (params.data?.fuelCodePrefix?.prefix) {
          ...
          return selectedOption?.prefix || params.data.prefix
        }
        const selectedOption = optionsData?.fuelCodePrefixes?.find(
    ...
    },
    {
      ...
      valueGetter: (params) => {
        if (params.data?.fuelCodeType?.fuelType) {
          ...
          return selectedOption?.fuelType || params.data.fuelType
        }
        const selectedOption = optionsData?.fuelTypes?.find(
    ...
    },
    {
      ...
      cellEditorParams: {
        noLabel: true,
        options: fieldOptions.feedstock,
        multiple: false,
        disableCloseOnSelect: false,
        freeSolo: true,
        openOnFocus: true
    ...
    },
    {
      ...
      cellEditorParams: {
        noLabel: true,
        options: fieldOptions.feedstockLocation,
        multiple: false,
        disableCloseOnSelect: false,
        freeSolo: true,
        openOnFocus: true
    ...
    },
    {
      ...
      cellEditorParams: {
        noLabel: true,
        options: fieldOptions.feedstockMisc,
        multiple: false,
        disableCloseOnSelect: false,
        freeSolo: true,
        openOnFocus: true
    ...
    },
    {
      ...
      headerComponent: canEdit ? RequiredHeader : undefined,
      headerName: i18n.t(
        'fuelCode:fuelCodeColLabels.fuelProductionFacilityCity'
      ),
      cellEditor: AsyncSuggestionEditor,
      suppressKeyboardEvent,
      cellDataType: 'text',
    ...
    },
    {
      ...
      editable: canEdit,
      headerName: i18n.t(
        'fuelCode:fuelCodeColLabels.facilityNameplateCapacity'
      ),
    ...
    },
    {
      ...
      cellRenderer: createCellRenderer('notes', (params) => {
        ...
        return (
          <div style={style}>
            {params.value ||
              (isNotesRequired && isEmpty ? 'Notes required' : '')}
          </div>
        )
      }),
      minWidth: 600
