...
vi.mock('@/components/BCDataGrid/components/Editors/AsyncSuggestionEditor', () => ({
...
vi.mock('@/components/BCDataGrid/components/Editors/TransportModeDistanceCellEditor', () => ({
