...
export class AllocationAgreementsService {
     ...
     */
    public static getTableOptions<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<GetTableOptionsResponse, GetTableOptionsError, ThrowOnError>({
            ...options,
    ...
    /**
     * Search Table Options Strings
     * Endpoint to search allocation agreement options based on a query string
     */
    public static searchTableOptionsStrings<ThrowOnError extends boolean = false>(options?: Options<SearchTableOptionsStringsData, ThrowOnError>) {
        return (options?.client ?? client).get<SearchTableOptionsStringsResponse, SearchTableOptionsStringsError, ThrowOnError>({
            ...options,
...
export class OrganizationsService {
     ...
     * Retrieve the total and reserved balances for a specific organization identified by its ID.
     */
    public static getBalances1<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<GetBalances1Response, GetBalances1Error, ThrowOnError>({
            ...options,
