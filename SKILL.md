...
- Do not introduce official or real company names in tests, fixtures, snapshots, seed data, docs, UI copy, or other text in changed files. Use clearly fictitious or placeholder names instead.
